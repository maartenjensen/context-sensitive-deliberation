...
from village_simulation.DelibCustom.Actions.csd_actions_custom import ActNone
...
class DecisionContext:
    ...
    def has_zero_of_type(self, node_type):
        all_nodes = self.my_dc.nodes
        nodes_of_type = []
        for node in all_nodes:
            if isinstance(node, node_type):
    ...
    # Specific functions that have to be refactored to use the base functions
